...
import os
import shutil
from testutil import test_result
...
def test_entropy():
    description = """ 
    This test ensures that average entropy of the inner 16 particles is within
    ...
    center_idx = np.argsort(time_30['r'])[:ninner]
...
def run():
    results = test_result(0, testname)
